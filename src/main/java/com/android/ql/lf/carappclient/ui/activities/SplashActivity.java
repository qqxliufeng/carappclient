...
import com.android.ql.lf.carappclient.component.ApiServerModule;
import com.android.ql.lf.carappclient.component.DaggerApiServerComponent;
import com.android.ql.lf.carappclient.data.UserInfo;
import com.android.ql.lf.carappclient.present.GetDataFromNetPresent;
...
public class SplashActivity extends BaseActivity implements EasyPermissions.PermissionCallbacks {
     ...
     * 需要的权限
     */
    private static final String[] REQUEST_PERMISSIONS = new String[]{Manifest.permission.CAMERA, Manifest.permission.WRITE_EXTERNAL_STORAGE, Manifest.permission.ACCESS_COARSE_LOCATION};

    private static final String[] REQUEST_PERMISSIONS_DESCRIPTION = new String[]{"相机", "读取SD卡", "当前位置"};
    ...
    public void initView() {
        DaggerApiServerComponent.builder().apiServerModule(new ApiServerModule()).appComponent(CarAppClientApplication.getInstance().getAppComponent()).build().inject(this);
