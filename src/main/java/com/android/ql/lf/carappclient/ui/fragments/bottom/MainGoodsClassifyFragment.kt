...
import com.android.ql.lf.carappclient.data.ClassifyBean
import com.android.ql.lf.carappclient.data.ClassifyItemEntity
import com.android.ql.lf.carappclient.data.SearchParamBean
import com.android.ql.lf.carappclient.data.lists.ListParseHelper
 ...
 */
class MainGoodsClassifyFragment : BaseNetWorkingFragment() {

    companion object {
        fun newInstance() = MainGoodsClassifyFragment()
    }
    ...
    override fun initView(view: View?) {
        ...
        val param = mTvMainClassifyBarContainer.layoutParams as ViewGroup.MarginLayoutParams
        param.topMargin = height
        mTvMainClassifyBarContainer.layoutParams = param
