...
import com.android.ql.lf.carappclient.component.ApiParams
...
class RequestParamsHelper {
    companion object {
        ...
        fun getAddShopcartParam(gid: String, shopid: String, num: String, specification: String, servicePrice: String) =
                getWithIdParams()
                        .addParam("gid", gid)
