...
import com.android.ql.lf.carappclient.data.BaseNetResult;
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof FragmentContainerActivity) {
            if (getParentFragment() == null) {
                ...
                DaggerApiServerComponent.builder().appComponent(CarAppClientApplication.getInstance().getAppComponent()).build().inject(this);
            }
        } else {
            DaggerApiServerComponent.builder().appComponent(CarAppClientApplication.getInstance().getAppComponent()).build().inject(this);
        }
